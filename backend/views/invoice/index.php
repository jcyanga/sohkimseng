...
<div class="row">
    ...
    <div class="col-md-2 pull-right">  
        <?= Html::button('<li class=\'fa fa-plus-square\'></li> New Invoice', ['class' => '_showCreateInvoiceModal formBtn btn btn-block btn-success btn-xs']) ?>
    </div>

    <div class="col-md-2 pull-right">  
        <?= Html::button('<li class=\'fa fa-plus-square\'></li> New Customer',['class' => '_showCreateCustomerByInvoiceModal formBtn btn btn-block btn-info btn-xs']) ?>
    </div>
...
<!-- Create Customer -->
<div class="modal fade" id="modal-launcher-create-customerbyinvoice" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
    <div class="modal-dialog">
        ...
        <div class="modal-footer">
            ...
            <?= Html::submitButton('<li class=\'fa fa-paper-plane-o\'></li> Submit Customer Information', ['id' => 'submitCustomerFormCreateByInvoice', 'class' => 'formBtn btn btn-primary']) ?>
        </div>
    ...
    <div class="modal-dialog modalInventoryDesign" >
        <div class="modal-content"> 
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> New Invoice </h5>
            </div>
            ...
            <?php $form = ActiveForm::begin(['method' => 'post', 'id' => 'invoiceFormCreate']); ?>
                ...
                <br/>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="labelStyle"><i class="fa fa-barcode"></i> Invoice Number</label>
                ...
                <div class="headerLabelContainer" >
                    ...
                    <br/>
                        ...
                        <input type="text" name="partsPrice" id="partsPrice" class="transactionForm inputboxWidth form-control" onchange="updatePartsSubtotalInvoice()" placeholder="$ 0.00" />
