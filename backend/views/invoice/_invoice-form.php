...
$this->title = 'Create Invoice for Customer';
...
<div class="invoice-create divContainer">
        ...
        <div class="row informationsContainer">
                ...
                <br/>
                    ...
                    <div class="col-md-6">
                        ...
                        <?= $form->field($model, 'quotation_code')->textInput(['class' => 'transactionForm form-control', 'id' => 'invoice_no', 'value' => $invoiceNo, 'readonly' => 'readonly'])->label(false) ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div id="invoice-customer-information" class="invoice-customer-information" >
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="pull-right">
        ...
        <?= Html::submitButton('<li class=\'fa fa-paper-plane-o\'></li> Submit Invoice', ['id' => 'submitInvoiceFormFromCustomer', 'class' => 'formBtn btn btn-primary']) ?>
    </div>
    <br/><br/><br/>
</div>
