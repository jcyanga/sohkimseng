...
/* @var $model common\models\SearchStaffGroup */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="staff-group-search">
...
<div class="row">
    ...
    <div class="col-md-4">
        <?= $form->field($model, 'name')->textInput(['class' => 'inputForm form-control', 'placeholder' => 'Enter Department name here.'])->label(false) ?>
    </div>
