...
$gridColumns = [
    [
        ...
        [
            'label' => 'AUTO-PARTS CATEGORY NAME',
            'value' => 'name',
            'options' => ['style' => 'color: #444']
        ],
        [
...
<div class="row">
    ...
    <div class="col-md-2 pull-right">  
        <?= Html::button('<li class=\'fa fa-user-plus\'></li> New Category -',['class' => '_showCreatePCModal formBtn btn btn-block btn-success btn-sm']) ?>
    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <?php $form = ActiveForm::begin(['method' => 'post', 'id' => 'pcFormCreate']); ?>
                ...
                <?= $form->field($model, 'description')->textarea(['class' => 'inputForm form-control', 'id' => 'description', 'rows' => 5, 'placeholder' => 'Enter Auto-Parts Category description here.'])->label(false) ?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <?php $form = ActiveForm::begin(['method' => 'post', 'id' => 'pcFormUpdate']); ?>
                ...
                <label class="labelStyle">Description</label>
                <?= $form->field($model, 'description')->textarea(['class' => 'inputForm form-control', 'id' => 'updateDescription', 'rows' => 5, 'placeholder' => 'Enter Auto-Parts Category description here.'])->label(false) ?>
