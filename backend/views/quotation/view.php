    ...
    <section class="content invoice">
        ...
        <div class="row">
            <div class="col-xs-12 invoice-header">
                <h3>
                <small class="pull-left quoteCodeAndDate" ><i class="fa fa-globe"></i> <?= $getQuoteInfo['quotation_code'] ?> </small>
                <small class="pull-right quoteCodeAndDate" ><i class="fa fa-calendar-plus-o"></i> Date Issue : <?= date('m/d/Y', strtotime($getQuoteInfo['date_issue'])) ?> </small>
                </h3>
            </div>
        </div>
        <br/>
        ...
        <div id="selectedServicesParts" class="row">
            <div class="col-xs-12 table">
                <table id="selecteditems" class="table table-boardered">
                    ...
                    <tbody>
                        <?php foreach( $getQuoteServicesInfo as $quotesRow ): ?>
                            <tr>
                                <td class="servicespartsLists" ><?= $quotesRow['quantity'] ?></td>
                                <td class="servicespartsLists" ></td>
                                <td class="servicespartsLists" ><?= $quotesRow['name'] ?></td>
                                <td class="servicespartsLists" ><?= number_format($quotesRow['unit_price'],2) ?></td>
                                <td class="servicespartsLists" ></td>
                                <td class="servicespartsLists" ><?= number_format($quotesRow['sub_total'],2) ?></td>
                            </tr> 
                        <?php endforeach; ?>
                        <?php foreach( $getQuotePartsInfo as $quotepRow ): ?>
                            <tr>
                                <td class="servicespartsLists" ><?= $quotepRow['quantity'] ?></td>
                                <td class="servicespartsLists" ><?= $quotepRow['parts_code'] ?></td>
                                <td class="servicespartsLists" ><?= $quotepRow['name'] ?></td>
                                <td class="servicespartsLists" ><?= number_format($quotepRow['unit_price'],2) ?></td>
                                <td class="servicespartsLists" ><?= $quotepRow['unit_of_measure'] ?></td>
                                <td class="servicespartsLists" ><?= number_format($quotepRow['sub_total'],2) ?></td>
                            </tr> 
                        <?php endforeach; ?>
                    </tbody>
                </table>
                    ...
                    <table class="table amountdueTbl">
                        <tbody>
                            <tr>
                                ...
                                <td class="amountdueTd" > <?= number_format($getQuoteInfo['grand_total'],2) ?> </td>
                            </tr>
                            <tr>
                                <th class="amountdueTh" >GST(7.00%) :</th>
                                <td class="amountdueTd" > <?= number_format($getQuoteInfo['gst'],2) ?> </td>
                            </tr>
                            <tr>
                                <th class="amountdueTh" >Amount Due :</th>
                                <td class="amountdueTd" > <?= number_format($getQuoteInfo['net'],2) ?> </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div class="row no-print">
            <div class="col-md-12">
                ...
                <div class="pull-right">
                    ...
                    <a class="quotationApproveColumn" id="<?= $getQuoteInfo['id'] ?>" ><button class="form-btn btn btn-primary btn-sm" ><i class="fa fa-question-circle-o"></i> Approve</button></a>
            ...
            <?php $form = ActiveForm::begin(['method' => 'post', 'id' => 'quoteFormUpdate']); ?>
                ...
                <div class="headerLabelContainer" >
                    ...
                    <br/>
                        ...
                        <input type="text" name="partsPrice" id="update_partsPrice" class="transactionForm inputboxWidth form-control" onchange="editPartsSubtotal()" placeholder="$ 0.00" />
