	...
	<div class="col-md-6">
		<div style="text-align: right;">
			<span class="edit-contactperson-address-button-<?= $ctr ?> edit-button">
                <a href="javascript:editSelectedContactPersonAddress(<?= $ctr ?>)" class="selectedBtns" ><i class="fa fa-edit"></i> Edit</a>
            </span>
            &nbsp;
            <span class="remove-button">
                <a href="javascript:removeSelectedContactPersonAddress(<?= $ctr ?>)" class="selectedBtns" ><i class="fa fa-trash"></i> Remove</a>
            </span>	
		</div>
	</div>
</div>
