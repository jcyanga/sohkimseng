...
class ServiceCategoryController extends Controller
{
    ...
    {  
        $getServiceCategories = ServiceCategory::findOne(Yii::$app->request->get('id'));

        $data = array();
        $data['id'] = $getServiceCategories->id;
        $data['name'] = $getServiceCategories->name;
        $data['description'] = $getServiceCategories->description;
        $data['status'] = $getServiceCategories->status;
    ...
    {
        $result = ServiceCategory::find()->where(['status' => 1])->all();
        ...
        $dompdf->stream('ServiceCategoryList-' . date('m-d-Y'));
    }
}
