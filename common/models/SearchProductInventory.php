...
/**
 * SearchProductInventory represents the model behind the search form about `common\models\ProductInventory`.
 */
class SearchProductInventory extends ProductInventory
{
    /**
     * @inheritdoc
     */
